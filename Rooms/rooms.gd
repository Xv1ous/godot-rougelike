...
const SPAWN_ROOMS: Array = [
	preload("res://Rooms/Spawn_Room_A.tscn"),
	preload("res://Rooms/Spawn_Room_B.tscn")
]
const INTERMEDIATE_ROOMS: Array = [preload("res://Rooms/Room.tscn")]
const SPECIAL_ROOMS: Array = [preload("res://Rooms/Room.tscn")] # Add your special room scenes here
const END_ROOMS: Array = [preload("res://Rooms/Room.tscn")]
